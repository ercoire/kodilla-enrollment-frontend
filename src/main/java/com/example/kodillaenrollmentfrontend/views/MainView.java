...
import com.example.kodillaenrollmentfrontend.views.course.*;
import com.example.kodillaenrollmentfrontend.views.payment.PaymentCreationView;
import com.example.kodillaenrollmentfrontend.views.student.StudentsView;
import com.example.kodillaenrollmentfrontend.views.student.StudentView;
import com.example.kodillaenrollmentfrontend.views.student.StudentEditView;
import com.example.kodillaenrollmentfrontend.views.student.StudentCreationView;
import com.example.kodillaenrollmentfrontend.views.teacher.TeacherCreationView;
import com.example.kodillaenrollmentfrontend.views.teacher.TeacherEditView;
import com.example.kodillaenrollmentfrontend.views.teacher.TeacherView;
import com.example.kodillaenrollmentfrontend.views.teacher.TeachersView;
...
public class MainView extends VerticalLayout {
    ...
    public MainView() {
     ...
     //   add(new RouterLink("Admin", AdminView.class));
        ...
        RouterLink coursesView = new RouterLink("CoursesView", CoursesView.class); //todo not working
